...
namespace OpenNos.GameObject
{
    public class BattleEntity
    {
        ...
        public MapMonster MapMonster { get; }
        ...
        public bool HasBuff(BCardType.CardType type, byte subType) => Buffs?.Where(s => s?.Card?.BCards != null)?.SelectMany(s => s.Card.BCards)?
            .Any(s => s.Type == (byte)type && s.SubType == (subType / 10)) == true;
