...
namespace OpenNos.GameObject.Event
{
    public static class InstantBattle
    {
        ...
        public static void GenerateInstantBattle()
        {
            ...
            {
                i++;
                if (s.Character.Level > 98 && level <= 98)
                {
                    i = 0;
                    instancelevel = 99;
                }
                    ...
                    for (int d = 0; d < 180; d++)
                    {
                        if (!mapinstance.Item1.Monsters.Any(s => s.CurrentHp > 0))
                        {
                            ...
                            foreach (ClientSession cli in mapinstance.Item1.Sessions.Where(s => s.Character != null).ToList())
                            {
                                ...
                                cli.Character.GiftAdd(1025, 3);
                                cli.Character.GiftAdd(1024, 3);
                ...
                switch (instantbattletype)
                {
                    ...
                    case 80:
                        switch (wave)
                        {
                            ...
                            case 1:
                                dropParameters.AddRange(generateDrop(map, 1046, 15, 1200));
                                dropParameters.AddRange(generateDrop(map, 1011, 15, 5));
                            ...
                            case 3:
                                dropParameters.AddRange(generateDrop(map, 1046, 30, 2000));
                    ...
                    case 99:
                        switch (wave)
                        {
                            ...
                            case 2:
                                ...
                                dropParameters.AddRange(generateDrop(map, 2283, 10, 30));
                                dropParameters.AddRange(generateDrop(map, 2284, 10, 30));
                                dropParameters.AddRange(generateDrop(map, 2285, 10, 30));
                                break;
