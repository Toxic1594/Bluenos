    ...
    public class CharacterHelper
    {
        ...
        private static void loadHPData()
        {
            ...
            for (int i = 0; i < _hp.GetLength(1); i++)
            {
                ...
                _hp[(int)ClassType.Wreastler, i] = hp;
            }

            // Magician HP
            for (int i = 0; i < _hp.GetLength(1); i++)
            {
                _hp[(int)ClassType.Magician, i] = (int)(((((i + 15) * (i + 15)) + i + 15.0) / 0.80) - 465 + 550);// durch 2.0
            }
        ...
        {
            _hpHealth = new int[5];
            _hpHealth[(int)ClassType.Archer] = 1200;
            _hpHealth[(int)ClassType.Adventurer] = 50;
            _hpHealth[(int)ClassType.Swordman] = 2500;
            _hpHealth[(int)ClassType.Magician] = 1500;
            _hpHealth[(int)ClassType.Wreastler] = 2000;
        }
       
        private static void loadHPHealthStand()
        {
            _hpHealthStand = new int[5];
            _hpHealthStand[(int)ClassType.Archer] = 320;
            _hpHealthStand[(int)ClassType.Adventurer] = 25;
            _hpHealthStand[(int)ClassType.Swordman] = 260;
            _hpHealthStand[(int)ClassType.Magician] = 200;
            _hpHealthStand[(int)ClassType.Wreastler] = 200;
        }
        ...
        private static void loadMPData()
        {
            ...
            for (int i = 1; i < _mp.GetLength(1) - 1; i++)
            {
                _mp[(int)ClassType.Wreastler, i] = _mp[(int)ClassType.Adventurer, i];
            }
        ...
        {
            _mpHealth = new int[5];
            _mpHealth[(int)ClassType.Adventurer] = 100;
            _mpHealth[(int)ClassType.Swordman] = 300;
            _mpHealth[(int)ClassType.Archer] = 500;
            _mpHealth[(int)ClassType.Magician] = 800;
            _mpHealth[(int)ClassType.Wreastler] = 900;
        }

        private static void loadMPHealthStand()
        {
            _mpHealthStand = new int[5];
            _mpHealthStand[(int)ClassType.Adventurer] = 50;
            _mpHealthStand[(int)ClassType.Swordman] = 160;
            _mpHealthStand[(int)ClassType.Archer] = 280;
            _mpHealthStand[(int)ClassType.Magician] = 400;
            _mpHealthStand[(int)ClassType.Wreastler] = 500;
        }
        ...
        private static void loadSpeedData()
        {
            ...
            _speedData[(int)ClassType.Adventurer] = 21;//11 // Toxic
            _speedData[(int)ClassType.Swordman] = 22;//12
            _speedData[(int)ClassType.Archer] = 24;//14
            _speedData[(int)ClassType.Magician] = 22;//12
            _speedData[(int)ClassType.Wreastler] = 23;//11
        }
        ...
        private static void loadStats()
        {
            ...
            for (int i = 0; i < 256; i++)
            {
                ...
                int add = i % 2 == 0 ? 2 : 4;
                _hitRate[(int)ClassType.Archer, 1] = 75;
                ...
                // UNKNOWN
                _criticalHitRate[(int)ClassType.Wreastler, i] = 0; // sure
                _criticalHit[(int)ClassType.Wreastler, i] = 0; // sure
                _criticalDistRate[(int)ClassType.Wreastler, i] = 0; // sure
                _criticalDist[(int)ClassType.Wreastler, i] = 0; // sure

                _minHit[(int)ClassType.Wreastler, i] = 9 + i * 3; // approx
                _maxHit[(int)ClassType.Wreastler, i] = 9 + i * 3; // approx
                _hitRate[(int)ClassType.Wreastler, 1] = 41;
                _minDist[(int)ClassType.Wreastler, i] = 2 * i; // approx
                _maxDist[(int)ClassType.Wreastler, i] = 2 * i; // approx

                _distRate[(int)ClassType.Wreastler, i] = 20 + 2 * i; // approx
                _hitDef[(int)ClassType.Wreastler, i] = i; // approx
                _magicalDef[(int)ClassType.Wreastler, i] = i + 2; // approx
                _hitDodge[(int)ClassType.Wreastler, i] = 41 + i; // approx
                _distDodge[(int)ClassType.Wreastler, i] = i + 2; // approx
                _distDef[(int)ClassType.Wreastler, i] = i; // approx
            }
        }
