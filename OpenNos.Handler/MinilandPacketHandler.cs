                    ...
                    case 8:
                        ...
                        switch (packet.Point)
                        {
                            case 0:
                                ...
                                mlobj.Level1BoxAmount = 0;
                                break;

                            case 1:
                                amount = mlobj.Level2BoxAmount;
                                mlobj.Level2BoxAmount = 0;
                                break;

                            case 2:
                                amount = mlobj.Level3BoxAmount;
                                mlobj.Level3BoxAmount = 0;
                                break;

                            case 3:
                                amount = mlobj.Level4BoxAmount;
                                mlobj.Level4BoxAmount = 0;
                                break;

                            case 4:
                                amount = mlobj.Level5BoxAmount;
                                mlobj.Level5BoxAmount = 0;
                                break;
                        }
                        ...
                        for (int i = 0; i < 9; i++)
                        {
                            if (gifts.Count > i)
                            {
                                ...
                                {
                                    Session.Character.SendGift(Session.Character.CharacterId, itemVNum, itemAmount, 0, 0, false,0);
                                }
