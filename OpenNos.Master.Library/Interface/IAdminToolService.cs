...
namespace OpenNos.Master.Library.Interface
{
    ...
    public interface IAdminToolService
    {
        ...
        void SendItem(string senderName, long receivingCharacterId, short vnum, int amount = 1, byte rare = 0, byte Upgrade = 0, bool isNosmall = false);
        ...
        /// <param name="Upgrade">Upgrade of the Item</param>
        /// <param name="isNosmall"></param>
        void SendItemToMap(Guid channelId, string senderName, Guid mapInstanceId, short vnum, int amount = 1, byte rare = 0, byte Upgrade = 0, bool isNosmall = false);
